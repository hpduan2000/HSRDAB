...
T1 = 2.11;
[PSA_ANR_2, PSV_ANR_2, a_ANR_2, v_APTR_2, v_ANR_2] = FD_alterPar_Np(1,40);
[PSA_ANR_3, PSV_ANR_3, a_ANR_3, v_APTR_3, v_ANR_3] = FD_alterPar_Np(2,10);
[PSA_ANR_4, PSV_ANR_4, a_ANR_4, v_APTR_4, v_ANR_4] = FD_alterPar_Np(2.5,100);
[PSA_ANR_5, PSV_ANR_5, a_ANR_5, v_APTR_5, v_ANR_5] = FD_alterPar_Np(3.5,0);
% subplot(4,1,1)
...
%%
% cai bo
path = 'D:\desktop\pulseparameter\fd\n5\';
...
%%
function [PSA_ANR, PSV_ANR, a_ANR, v_APTR, v_ANR] = FD_alterPar_Np(gama, phase)
    % ..........(1) 读取地震波从peer
