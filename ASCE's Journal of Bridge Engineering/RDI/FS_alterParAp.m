...
[PSA_ANR_100, PSV_ANR_100, a_ANR_100] = FS_alterPar_Ap(80);
[PSA_ANR_150, PSV_ANR_150, a_ANR_150] = FS_alterPar_Ap(100);
[PSA_ANR_200, PSV_ANR_200, a_ANR_200] = FS_alterPar_Ap(120);
[PSA_ANR_250, PSV_ANR_250, a_ANR_250] = FS_alterPar_Ap(140);
%
...
%%
function [PSA_ANR, PSV_ANR, a_ANR] = FS_alterPar_Ap(Ap)
    % ..........(1) 读取地震波从peer
