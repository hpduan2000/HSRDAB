...
T1 = 2.11;
[PSA_ANR_05, PSV_ANR_05, a_ANR_05] = FS_alterPar_Tp(0.5*T1);
[PSA_ANR_10, PSV_ANR_10, a_ANR_10] = FS_alterPar_Tp(1.0*T1);
[PSA_ANR_15, PSV_ANR_15, a_ANR_15] = FS_alterPar_Tp(1.5*T1);
[PSA_ANR_20, PSV_ANR_20, a_ANR_20] = FS_alterPar_Tp(2.0*T1);
%%
...
%%
% cai bo
path = 'D:\desktop\pulseparameter\fs\tp2.0\';
